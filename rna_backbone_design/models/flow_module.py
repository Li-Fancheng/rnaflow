...
from rna_backbone_design.data.complex_constants import NUM_NA_TORSIONS
...
class FlowModule(LightningModule):
    ...
    def model_step(self, noisy_batch):
        ...
        torsions_end_index = NUM_NA_TORSIONS
    ...
    def predict_step(self, batch):
        ...
        rna_base_indices = torch.tensor([25, 26, 27, 28], device=self.device)
        random_aatype = rna_base_indices[torch.radnint(0, 4, (1, sample_length), device=self.device)]
        ...
        saved_rna_path = au.write_complex_to_pdbs(
                ...
                restype=du.to_numpy(random_aatype[0])
            )
